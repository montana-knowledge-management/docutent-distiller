...
class PuLearningTestCase(unittest.TestCase):
    ...
    def test_choose_model_raising_error(self):
        ...
        self.assertTrue(
            "Wrong model type given. Please choose from ['lr','svc'] or use a model object where the 'fit' "
    ...
    def test_train_test_split(self):
        ...
        X_train, X_test, y_train, y_test = train_test_split(
            X, y, shuffle=True, stratify=y, random_state=1, test_size=0.2
        )
    ...
    def test_get_potential_positives(self):
        ...
        P = np.array([[1], [2], [3]])
        U = np.array([[5], [5], [5], [2]])
        potential_positive_index = pu_learner.get_potential_positives(P=P, U=U, model="lr", n_splits=2, random_state=1)
